            ...
            <div class="row">
                <div class="col-md-9 post-content" data-aos="fade-up">
                    ...
                    <div class="single-post">
                        ...
                        <p><span class="firstcharacter">{{substr($blog->description,0,1)}}</span>{{substr($blog->description,1,150)}}</p>
                        <div class="my-4">
                            <img src="{{asset($blog->image)}}" alt="" height="400px" width="800px" class="img-fluid">
                        </div>
                        <p>{{substr($blog->description,1000)}}</p>
                    ...
                    @else
                        <h3 class="text-primary mt-3">Please <a class="text-warning" href="{{route('user.login')}}">Login</a> for comment</h3>
                    @endif
                    <!-- End Comments Form -->
                            ...
                            <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                                ...
                                <div class="post-entry-1 border-bottom">
                                    <div class="post-meta"><span class="date">{{$categoryWiseBlog->category_name}}</span>
                                        <span class="mx-1">&bullet;</span> <span>{{$categoryWiseBlog->date}}</span></div>
